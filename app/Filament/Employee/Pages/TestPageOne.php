...
class TestPageOne extends BaseEmployeePage
{
    ...
    protected static ?string $requiredPermission = 'employee_test_page_1_view';
    ...
    public function mount(): void
    {
        ...
        $this->canAdd = auth()->user()?->can('employee_test_page_1_add');
        $this->canDelete = auth()->user()?->can('employee_test_page_1_delete');
    }
